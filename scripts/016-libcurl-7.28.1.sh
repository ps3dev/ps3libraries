#!/bin/sh -e
# libcurl-7.28.1 by deroad (thanks KaKaRoTo)

## Download the source code.
wget --continue http://curl.haxx.se/download/curl-7.28.1.tar.gz

## Unpack the source code.
rm -Rf curl-7.28.1 && tar xfvz curl-7.28.1.tar.gz && cd curl-7.28.1

## Patch the source code.
cat ../../patches/libcurl-7.28.1.patch | patch -p1 -R
